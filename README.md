...
Para el análisis de los datos usaremos R y para la presentación se creó un dashboard que se puede consultar dando click en esta 
[liga](https://anatorresramirez.shinyapps.io/Practica_final/)
